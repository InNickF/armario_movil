...
class BannerAPIController extends \App\Http\Controllers\Controller
{
    ...
    public function show($id)
    {
        ...
        if (empty($banner)) {
            return $this->sendError('Banner no encontrad@');
        }
    ...
    public function destroy($id)
    {
        ...
        return $this->sendResponse($id, 'Banner ha sido eliminado');
    }
}
