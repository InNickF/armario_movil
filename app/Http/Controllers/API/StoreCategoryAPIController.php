...
class StoreCategoryAPIController extends \App\Http\Controllers\Controller
{
    ...
    public function show($id)
    {
        ...
        if (empty($storeCategory)) {
            return $this->sendError('Store Category no encontrad@');
        }
    ...
    public function destroy($id)
    {
        ...
        return $this->sendResponse($id, 'Store Category ha sido eliminado');
    }
}
