...
class ProductAddedToCart extends Notification
{
    ...
    private $product;
    private $title = 'Han agregado tu producto al carrito de compras';
    private $body;
    private $user;
    /**
    ...
    public function __construct(Product $product, User $user = null)
    {
        ...
        $this->user = $user;
        $this->body = ($this->user ? $this->user->full_name : 'Un usuario ') . ' ha agregado ' . $this->product->name . ' a su carrito de compras';
    }
