...
class StoreUnfollowed extends Notification
{
    use Queueable;
    ...
    private $store;
    private $user;
    private $title = 'Te han dejado de seguir';
    private $body;
    /**
    ...
    public function __construct(UserStore $store, User $user)
    {
        $this->store = $store;
        $this->user = $user;
        $this->body = 'El usuario ' . $this->user->full_name . ' ha dejado de seguir a tu tienda';
    }
    /**
