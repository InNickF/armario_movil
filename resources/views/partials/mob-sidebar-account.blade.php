      ...
      <div class="modal fade modal-bg modal-bg-2 p-4" id="mobSidebar" role="dialog" aria-labelledby="mobSidebar" aria-hidden="true" data-backdrop="false">
              ...
              <div class="modal-content h-100">
                  ...
                  <div class="modal-body">
                      <div class="modal-header">
                          <ul class="position-fixed navbar-nav max-height-100-vh sidebar accordion sidebar-container bg-gradient rounded pb-5 o-visible pr-1 d-flex" id="accordionSidebar">

<!-- Sidebar - Brand -->
  <div class="bg-cover">
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/') }}">
      <div class="sidebar-brand-text p-2 p-sm-3 w-50 mw-100">
        <div class="logo-no-collapse">

          <img src="{{setting('logo_image', asset('images/icons/logo-armario-movil.png'))}}" class="img-fluid" alt="">
        </div>
      </div>
    </a>

    <a class="" href="{{ url('/account/profile') }}">
  ...
  <div id="cont-menu-sidebar" class="p-0">
    ...
    <li class="nav-item">
      <a class="w-100 nav-link nav-link-non-collapsed__style nav-link-non-collapsed__style collapsed" href="#" data-toggle="collapse" data-target="#store" aria-expanded="true"
        aria-controls="store">
        <img src="{{ asset('images/icons/sidebar/bag-icon.svg') }}" class="img-sidebar image-svg icon-light" alt="">
        <span class="">Armario de compras</span>
      </a>
      ...
      <div id="store" class="collapse style-subitem-on-collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-transparent py-2 collapse-inner">
          ...
          <div class="ml-4 text-left mb-3">
            <a class="w-100 nav-item" href="{{ url('/account/orders') }}">
              <img src="{{ asset('images/icons/sidebar/usd-icon.svg') }}" class="img-sidebar image-svg icon-light"
                alt="">
              <span class="">Mis compras</span>
            </a>
          </div>

          <div class="ml-4 text-left mb-3">
              <a class="w-100 nav-item" href="{{ url('/account/wishlist') }}">
                <img src="{{ asset('images/icons/sidebar/heart-icon.svg') }}" class="img-sidebar image-svg icon-light"
                  alt="">
                  {{-- <i class="fa fa-heart text-white"></i> --}}
                <span class="">Mis favoritos</span>
              </a>
            </div>

          <div class="ml-4 text-left mb-0">
            <a class="w-100 nav-item" href="{{ url('/account/questions') }}">
              <img src="{{ asset('images/icons/sidebar/question-icon.svg') }}"
                class="img-sidebar image-svg icon-light" alt="">
              <span class="">Mis preguntas</span>
            </a>
          </div>

          <div class="ml-4 mt-3 text-left pl-2 mb-0">
                <a class="w-100 nav-item" href="{{ url('/account/followed_categories') }}">
    ...
    <!-- Nav Item - Pages Collapse Menu -->
    <li class="nav-item">
      <a class="w-100 nav-link nav-link-non-collapsed__style collapsed" href="#" data-toggle="collapse" data-target="#store-store" aria-expanded="true"
        aria-controls="store-store">
        <img src="{{ asset('images/icons/sidebar/shirt-icon.svg') }}" class="img-sidebar image-svg icon-light" alt="">
        <span class="">Armario de ventas</span>
      </a>

      <div id="store-store" class="collapse style-subitem-on-collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-transparent py-2 collapse-inner">
          <div class="ml-4 text-left mb-3">
            <a class="w-100 nav-item" href="{{ url('/account/products') }}">
              <img src="{{ asset('images/icons/sidebar/shirt-icon-2.svg') }}" class="img-sidebar image-svg icon-light"
                alt="">
              <span class="">Mis productos</span>
            </a>
          </div>

          <div class="ml-4 text-left mb-3">
              <a class="w-100 nav-item" href="{{ url('/account/outfits') }}">
                <img src="{{ asset('images/icons/sidebar/shirt-icon-2.svg') }}" class="img-sidebar image-svg icon-light"
                  alt="">
                <span class="">Mis outfits</span>
              </a>
            </div>


            <div class="ml-4 text-left mb-3">
                <a class="w-100 nav-item" href="{{ url('/account/stories') }}">
                  <img src="{{ asset('images/icons/sidebar/shirt-icon-2.svg') }}" class="img-sidebar image-svg icon-light"
                    alt="">
                  <span class="">Mis historias</span>
                </a>
              </div>

          <div class="ml-4 text-left mb-3">
            <a class="w-100 nav-item" href="{{ url('account/store/orders') }}">
              <img src="{{ asset('images/icons/sidebar/usd-icon.svg') }}" class="img-sidebar image-svg icon-light"
                alt="">
              <span class="">Mis ventas</span>
            </a>
          </div>

          {{-- <div class="ml-4 text-left mb-3">
          <a class="w-100 nav-item" href="{{ url('/account/ads') }}">
          <img src="{{ asset('images/icons/sidebar/flag-icon.svg') }}" class="img-sidebar image-svg icon-light"
            alt="">
          <span class="">Anuncios</span>
          </a>
        </div> --}}


        <div class="ml-4 text-left mb-3">
          <a class="w-100 nav-item" href="{{ url('/account/storeReviews') }}">
            <img src="{{ asset('images/icons/sidebar/star-icon.svg') }}" class="img-sidebar image-svg icon-light"
              alt="">
            <span class="">Mis Calificaciones</span>
          </a>
        </div>

        {{-- <div class="ml-4 text-left mb-3">
          <a class="w-100 nav-item" href="{{ url('/account/reports') }}">
        <img src="{{ asset('images/icons/sidebar/screen-icon.svg') }}" class="img-sidebar image-svg icon-light"
          alt="">
        <span class="">Mis reportes</span>
        </a>
      </div> --}}

      <div class="ml-4 text-left mb-3">
        <a class="w-100 nav-item" href="{{ url('/account/plans') }}">
          <img src="{{ asset('images/icons/sidebar/diamond-icon.svg') }}" class="img-sidebar image-svg icon-light"
            alt="">
          <span class="">Mi suscripción</span>
        </a>
      </div>

      <div class="ml-4 text-left mb-3">
        <a class="w-100 nav-item" href="{{ url('/account/answers') }}">
          <img src="{{ asset('images/icons/sidebar/question-icon.svg') }}" class="img-sidebar image-svg icon-light"
            alt="">
          <span class="">Preguntas recibidas</span>
        </a>
      </div>


      <div class="ml-4 text-left">
        <a class="w-100 nav-item" href="{{ url('/account/store/gallery') }}">
          <i class="fa fa-image fix"></i>
          <span class="pl-2 ">Galería de tienda</span>
        </a>
      </div>
...
<!-- Nav Item - Pages Collapse Menu -->
<li class="nav-item">
  <a class="w-100 nav-link nav-link-non-collapsed__style collapsed" href="#" data-toggle="collapse" data-target="#reports" aria-expanded="true"
  ...
  <div id="reports" class="collapse style-subitem-on-collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-transparent py-2 collapse-inner rounded">
      ...
      <div class="mb-4 ml-4 text-left">
        <a class="w-100 nav-item" href="{{ url('/account/dashboards/sell_records') }}">
          <img src="{{ asset('images/icons/sidebar/clock-icon.svg') }}" class="img-sidebar image-svg icon-light"
            alt="">
          <span class="">Historial de ventas</span>
        </a>
      </div>

      <div class="mb-4 ml-4 text-left">
        <a class="w-100 nav-item" href="{{ url('/account/dashboards/business_profile') }}">
          <img src="{{ asset('images/icons/sidebar/shopping-cart-icon.svg') }}"
            class="img-sidebar image-svg icon-light" alt="">
          <span class="">Perfil comercial</span>
        </a>
      </div>

      <div class="mb-4 ml-4 text-left position-relative pro-analytic-mob">
        <a class="w-100 nav-item" href="{{ url('/account/dashboards/interactions') }}">
          <img src="{{ asset('images/icons/sidebar/pointer-icon.svg') }}" class="img-sidebar image-svg icon-light"
            alt="">
          <span class="">Interacciones</span>
        </a>
      </div>

      <div class="mb-4 ml-4 text-left position-relative pro-analytic-mob">
        <a class="w-100 nav-item" href="{{ url('/account/dashboards/products') }}">
          <img src="{{ asset('images/icons/sidebar/box-icon.svg') }}" class="img-sidebar image-svg icon-light" alt="">
          <span class="">Categorías de<br>productos</span>
        </a>
      </div>

      <div class="mb-4 ml-4 text-left position-relative pro-analytic-mob">
        <a class="w-100 nav-item" href="{{ url('/account/dashboards/cities') }}">
      ...
      <div class="ml-4 text-left position-relative pro-analytic-mob">
        <a class="w-100 nav-item" href="{{ url('/account/dashboards/funnel') }}">
          <img src="{{ asset('images/icons/sidebar/funnel-icon.svg') }}" class="img-sidebar image-svg icon-light"
            alt="">
          <span class="">Embudo</span>
        </a>
      </div>
...
<li class="nav-item">
  ...
  <div id="assesment" class="collapse style-subitem-on-collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-transparent py-2 collapse-inner rounded">
      ...
      <div class="mb-4 ml-4 text-left">
        <a class="w-100 nav-item" href="{{ url('/account/articles/category/2') }}">
          <img src="{{ asset('images/icons/sidebar/camera-icon.svg') }}" class="img-sidebar image-svg icon-light"
            alt="">
          <span class="">Fotografías</span>
        </a>
      </div>

      <div class="mb-4 ml-4 text-left">
        <a class="w-100 nav-item" href="{{ url('/account/articles/category/3') }}">
          <img src="{{ asset('images/icons/sidebar/marketing-icon.svg') }}" class="img-sidebar image-svg icon-light"
            alt="">
          <span class="">Marketing Digital</span>
        </a>
      </div>

      <div class="ml-4 text-left">
        <a class="w-100 nav-item" href="{{ url('/account/articles/category/4') }}">
          <img src="{{ asset('images/icons/sidebar/screen-money-icon.svg') }}"
            class="img-sidebar image-svg icon-light" alt="">
          <span class="">Negocios digitales</span>
        </a>
      </div>
...
<!-- Nav Item - Pages Collapse Menu -->
<li class="nav-item">
  <a class="w-100 nav-link nav-link-non-collapsed__style collapsed" href="#" data-toggle="collapse" data-target="#config" aria-expanded="true"
  ...
  <div id="config" class="collapse style-subitem-on-collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-transparent py-2 collapse-inner rounded">
      ...
      {{-- <div class="mb-4 ml-4 text-left">
        <a class="w-100 nav-item" href="{{ url('/account/followed_categories') }}"> --}}
          {{-- <img src="{{ asset('images/icons/sidebar/lock-icon.svg') }}" class="img-sidebar image-svg icon-light"
            alt=""> --}}
          {{-- <i class="fa fa-cog"></i>
          <span class="">Preferencias</span>
        </a>
      </div> --}}


      <div class="mb-4 ml-4 text-left">
        <a class="w-100 nav-item" href="{{ url('/account/password') }}">
          <img src="{{ asset('images/icons/sidebar/lock-icon.svg') }}" class="img-sidebar image-svg icon-light"
            alt="">
      ...
      <div class="mb-4 ml-4 text-left">
        <a class="w-100 nav-item" href="{{ url('/account/addresses') }}">
      ...
      <div class="mb-4 ml-4 text-left">
        <a class="w-100 nav-item" href="{{ url('/account/billing') }}">
      ...
      <div class="mb-4 ml-4 text-left">
        <a class="w-100 nav-item" href="{{ url('/account/payment') }}">
          <img src="{{ asset('images/icons/sidebar/coin-hand-icon.svg') }}" class="img-sidebar image-svg icon-light"
            alt="">
          <span class="">Pagos y cobros</span>
        </a>
      </div>

      <div class="ml-4 text-left">
        <a class="w-100 nav-item" href="{{ url('/account/notifications') }}">
...
<li class="nav-item">
  <a class="w-100 nav-link" href="{{ url('/logout') }}" data-toggle="modal" data-target="#logoutModal">
    ...
    <span class="">Cerrar sesión</span></a>
</li>
