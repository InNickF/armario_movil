                        ...
                        <tbody>
                            <tr style="padding:0;text-align:left;vertical-align:top">
                                <td
                                                                    ...
                                                                    <tr
                                                                        ...
                                                                        <th
                                                                            ...
                                                                            <table class="spacer"
                                                                                ...
                                                                                src="{{asset('/images/emails/regateo-icon.png')}}" alt>
                                                                            ...
                                                                            <p class="text-center"
                                                                                ...
                                                                                {{$store->name}} te ha hecho una contraoferta</p>
                                                                        </th>
                                                                        <th class="expander"
                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <th
                                                                style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
                                                                <p
                                                                    style="Margin:0;Margin-bottom:10px;color:#181b48;font-family:Montserrat,sans-serif;font-size:14px;font-weight:400;hyphens:none!important;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:center">
                                                                    #Nombre, queremos hacerte una contraoferta del valor
                                                                    que nos has ofrecido por el producto:</p>
                                                            </th>
                                                            <th class="expander"
                                                                style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0!important;text-align:left;visibility:hidden;width:0">
                                                            </th>
                                                ...
                                                <th class="small-12 large-4 columns first"
                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <th
                                                                style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
                                                                <img style="-ms-interpolation-mode:bicubic;border-radius:150px;clear:both;display:block;height:auto;margin:auto;max-width:150px;outline:0;text-decoration:none;width:100%"
                                                                    src="https://picsum.photos/150" alt></th>
                                                        </tr>
                                                    </table>
                                                </th>
                                                                                    ...
                                                                                    <tr
                                                                                        ...
                                                                                        <th
                                                                                            ...
                                                                                            <h4 class="small-text-center"
                                                                                                style="Margin:0;Margin-bottom:10px;color:inherit;font-family:Montserrat,sans-serif;font-size:24px;font-weight:lighter!important;hyphens:none!important;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:left;word-wrap:normal">
                                                                                    ...
                                                                                    <tr
                                                                                        ...
                                                                                        <th
                                                                                            ...
                                                                                            <p class="small-text-center"
                                                                                                style="Margin:0;Margin-bottom:10px;color:#0a0a0a;font-family:Montserrat,sans-serif;font-size:12px;font-weight:400;hyphens:none!important;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:left">
                                                                                                <strong>Color:</strong>
                                                                                                <!-- Color --> <span
                                                                                                    style="background-image:url({{asset('images/emails/gradient.png')}});background-position:center center;background-size:cover;border-radius:100px;box-sizing:border-box;display:inline-block;font-family:Montserrat,sans-serif;height:13px;hyphens:none!important;padding:1px;width:13px"><span
                                                                                                        style="background-color:#32cd32;border:solid 1px #fff;border-radius:100px;box-sizing:border-box;display:inline-block;font-family:Montserrat,sans-serif;height:11px;hyphens:none!important;width:11px"></span>
                                                                                                </span>
                                                                                                <!-- END Color -->
                                                                                            </p>
                                                                                        </th>
                                    ...
                                    <!-- Container Footer -->
                                    <table
                                        style="background-image:url({{asset('images/emails/gradient.png')}});background-position:center center;background-repeat:no-repeat;background-size:100% 100%;border-collapse:collapse;border-radius:0 0 24px 24px;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%"
                                        class="wrapper" align="center">
                                        <tr style="padding:0;text-align:left;vertical-align:top">
                                            <td class="wrapper-inner"
                                                style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;hyphens:auto;line-height:1.3;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                                                    ...
                                                                    <tr
                                                                        ...
                                                                        <th
                                                                            ...
                                                                            <h2 class="text-center"
                                                                                style="Margin:0;Margin-bottom:10px;color:#fff;font-family:Montserrat,sans-serif;font-size:30px;font-weight:lighter!important;hyphens:none!important;line-height:1.3;margin:0;margin-bottom:1%;padding:0;text-align:center;word-wrap:normal">
                                                                                Mi contraoferta es de</h2>
                                                                            <p class="text-center"
                                                                                style="Margin:0;Margin-bottom:10px;color:#fff;font-family:Montserrat,sans-serif;font-size:16px;font-weight:400;hyphens:none!important;line-height:1.3;margin:0;margin-bottom:4%;padding:0;text-align:center">
                                                                                $250,00</p>
                                                                        </th>
                                                                        <th class="expander"
                                                                            style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0!important;text-align:left;visibility:hidden;width:0">
                                                                ...
                                                                <table
                                                                    ...
                                                                    <tr
                                                                        ...
                                                                        <th
                                                                            ...
                                                                            <!-- BTN Line -->
                                                                            <center data-parsed
                                                                                style="min-width:532px;width:100%"><a
                                                                                    target="_blank"
                                                                                    style="Margin:0;border:1px solid #fff;border-radius:150px;box-sizing:border-box;color:#fff;font-family:Montserrat,sans-serif;font-size:14px;font-weight:400;hyphens:none!important;line-height:1.3;margin:auto;padding:.7em 2em;text-align:center;text-decoration:none"
                                                                                    href="#" align="center"
                                                                                    class="float-center">Ir a la páginda
                                                                                    de regateo</a><!-- ADD LINK -->
                                                                            </center><!-- END BTN Line -->
                                                                        </th>
                                                                        <th class="expander"
                                                                            style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0!important;text-align:left;visibility:hidden;width:0">
