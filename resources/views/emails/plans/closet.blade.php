...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en" style="background-color:#181b48!important">

<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <meta name="viewport" content="width=device-width">
    <title>Paln Clóset</title>
    <style>
        @media only screen {
            html {
                min-height: 100%;
...
<body
    ...
    <table class="body"
        style="Margin:0;background:#f3f3f3;background-color:#181b48!important;border-collapse:collapse;border-spacing:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;height:100%;line-height:1.3;margin:0;padding:0;text-align:left;vertical-align:top;width:100%">
        <tr style="padding:0;text-align:left;vertical-align:top">
            <td class="center" align="center" valign="top"
                ...
                <center data-parsed style="min-width:580px;width:100%">
                                                ...
                                                <table
                                                    ...
                                                    <tr style="padding:0;text-align:left;vertical-align:top">
                                                        <th
                                                            ...
                                                            src="{{setting('logo_image_png', asset('images/icons/logo-armario-movil.png'))}}" alt></th>
                                                        <th class="expander"
                                                    ...
                                                    <tr style="padding:0;text-align:left;vertical-align:top">
                                                        <th
                                                            ...
                                                            <p class="text-right small-text-center"
                                                                ...
                                                                src="{{asset('/images/emails/credit-card-icon.png')}}" alt> TARJETAS DE
                                                                CRÉDITO/DÉBITO</p>
                                                        </th>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <tr style="padding:0;text-align:left;vertical-align:top">
                                                        <th
                                                            ...
                                                            <p class="text-center small-text-center"
                                                                ...
                                                                <img style="-ms-interpolation-mode:bicubic;clear:both;display:inline-block;height:auto;margin:auto;max-width:12px;outline:0;position:relative;text-decoration:none;top:3px;width:100%"
                                                                src="{{asset('/images/emails/delivery-small-icon.png')}}" alt> ENTREGAS
                                                                LOCALES EN 3 HORAS</p>
                                                        </th>
                                                    </tr>
                                                </table>
                                            </th>
                                                    ...
                                                    <tr style="padding:0;text-align:left;vertical-align:top">
                                                        <th
                                                            ...
                                                            <p class="text-left small-text-center"
                                                                ...
                                                                <img style="-ms-interpolation-mode:bicubic;clear:both;display:inline-block;height:auto;margin:auto;max-width:12px;outline:0;position:relative;text-decoration:none;top:3px;width:100%"
                                                                src="{{asset('/images/emails/offert-icon.png')}}" alt> OFERTAS EXCLUSIVAS
                                                            </p>
                                                        </th>
                                                    </tr>
                                                </table>
                    ...
                    <!-- Content Header -->
                    <table
                        style="Margin:0 auto;background:#fefefe;border-collapse:collapse;border-radius:18px;border-spacing:0;box-shadow:0 0 13px 8px rgba(0,255,255,.3);float:none;margin:0 auto;padding:0;text-align:center;vertical-align:top;width:580px"
                        ...
                        <tbody>
                            <tr style="padding:0;text-align:left;vertical-align:top">
                                <td
                                    style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;hyphens:auto;line-height:1.3;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                    <table
                                        style="background-image:url({{asset('images/emails/banner2.png')}});background-position:center center;background-repeat:no-repeat;background-size:cover;border-collapse:collapse;border-radius:12px;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%"
                                                                    ...
                                                                    <tr
                                                                        ...
                                                                        <th
                                                                            ...
                                                                            <table class="spacer"
                                                                                ...
                                                                                src="{{asset('/images/emails/diamond-icon.png')}}" alt>
                                                                            <h1 class="text-center"
                                                                                ...
                                                                                ¡Felicidades, {{ $user->first_name }}!</h1>
                                                                            <p class="text-center"
                                                                                style="Margin:0;Margin-bottom:10px;color:#fff;font-family:Montserrat,sans-serif!important;font-size:12px;font-weight:lighter!important;hyphens:none!important;line-height:1.3;margin:0;margin-bottom:10px;padding:0 10%;text-align:center">
                                                                                Has cambiado de suscripción
                                                                                exitosamente.<br>Tu nuevo nivel es:</p>
                                                                            <img style="-ms-interpolation-mode:bicubic;clear:both;display:block;height:auto;margin:auto;max-width:120px;outline:0;padding-bottom:8px;text-decoration:none;width:100%"
                                                                            src="{{asset('/images/emails/plan-closet.png')}}" alt>
                                                                            <p class="text-center"
                                                                                style="Margin:0;Margin-bottom:10px;color:#fff;font-family:Montserrat,sans-serif!important;font-size:12px;font-weight:lighter!important;hyphens:none!important;line-height:1.3;margin:0;margin-bottom:10px;opacity:.6;padding:0 10%;text-align:center">
                                                                                Conoce todos tus beneficios</p>
                                                                        </th>
                                                                        <th class="expander"
                                                                            style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0!important;text-align:left;visibility:hidden;width:0">
                                                                        </th>
                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <th
                                                                style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
                                                                <p class="text-center"
                                                                    style="Margin:0;Margin-bottom:10px;color:#181b48;font-family:Montserrat,sans-serif!important;font-size:14px;font-weight:lighter!important;hyphens:none!important;line-height:32px;margin:0;margin-bottom:10px;padding:0 10%;text-align:center">
                                                                    <strong style="font-size:16px">Características
                                                                        funcionales</strong><br>Suscripción con
                                                                    cédula<br>Suscripción con RUC<br>Perfil
                                                                    Comercial<br>Publicación de 15 productos<br>30 días
                                                                    de anuncio activos<br>Publicación de productos
                                                                    outfit<br>Botón de Pago<br>Servicio
                                                                    logístico<br>Calculadora de precios, impuestos y
                                                                    comisiones<br>Códigos de descuento<br>Tarifa de
                                                                    comisión sobre la venta de un 17%<br>Certificado SSL
                                                                    (venta y envío seguro)<br>Posicionamiento en motores de búsqueda<br><br><strong
                                                                        style="font-size:16px">Reporte y
                                                                        Dashboard</strong><br>Historial de
                                                                    ventas<br>Perfil comercial<br>Dashboard profesional
                                                                    (Visitas)<br><br><strong
                                                                        style="font-size:16px">Asesoría
                                                                        Comercial</strong><br>Asesoría en
                                                                    Moda<br>Asesoría en Fotografía
                                                                    Profesional<br><br><strong
                                                                        style="font-size:16px">Espacios
                                                                        Publicitarios</strong><br>Ofertas 24 horas (una
                                                                    historia por marca por día)<br>Subastas<br><br><strong
                                                                        style="font-size:16px">Precio</strong><br>Pago
                                                                    mensual de $8.99</p>
                                                            </th>
                                                            <th class="expander"
                                                                style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0!important;text-align:left;visibility:hidden;width:0">
                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <th
                                                                style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
                                                                <a target="_blank"
                                                                    style="Margin:0;background:url({{asset('images/emails/gradient.png')}});background-position:center center;background-size:cover;border-radius:150px;box-sizing:border-box;color:#fff;display:block;font-family:Montserrat,sans-serif!important;font-size:14px;font-weight:400;hyphens:none!important;line-height:1.3;margin:auto;padding:.7em 0;text-align:center;text-decoration:none;width:80%"
                                                                    href="http://www.armariomovil.com">Iniciar sesión en Armario Móvil</a>
                                                                <!-- ADD LINK -->
                                                            </th>
                                                            <th class="expander"
                                                                style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0!important;text-align:left;visibility:hidden;width:0">
                                        ...
                                        <tbody>
                                            <tr style="padding:0;text-align:left;vertical-align:top">
                                                <th class="small-4 large-4 columns first"
                                                    style="Margin:0 auto;border-bottom:solid 1px #85869d;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0 auto;padding:0;padding-bottom:16px;padding-left:16px;padding-right:8px;text-align:left;width:177.33px">
                                                    <table
                                                        style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                        <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <th
                                                                style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
                                                                <a target="_blank"
                                                                    style=";padding-top:18px; Margin: 0; color: #85869d; display: block; font-family: 'Montserrat',sans-serif !important; font-size: 10px; font-weight: normal; hyphens: none !important; line-height: 1.3; margin: 0; padding: 0; padding-top: 10px; text-align: center; text-decoration: none"
                                                ...
                                                <th class="small-4 large-4 columns"
                                                    style="Margin:0 auto;border-bottom:solid 1px #85869d;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0 auto;padding:0;padding-bottom:16px;padding-left:8px;padding-right:8px;text-align:left;width:177.33px">
                                                    <table
                                                        style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                        <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <th
                                                ...
                                                <th class="small-3 large-3 columns"
                                                    style="Margin:0 auto;border-bottom:solid 1px #85869d;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0 auto;padding:0;padding-bottom:16px;padding-left:8px;padding-right:8px;text-align:left;width:129px">
                                                    <table
                                                        style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                        <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <th
                                                ...
                                                <th class="small-3 large-3 columns last"
                                                    style="Margin:0 auto;border-bottom:solid 1px #85869d;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0 auto;padding:0;padding-bottom:16px;padding-left:8px;padding-right:16px;text-align:left;width:129px">
                                                    <table
                                                        style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                        <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <th
                    ...
                    <table
                        ...
                        <tr style="padding:0;text-align:left;vertical-align:top">
                            <td class="wrapper-inner"
                                style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;hyphens:auto;line-height:1.3;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                <table
                                    style="background-image:url({{asset('images/emails/gradient.png')}});background-position:center center;background-repeat:no-repeat;background-size:100% 100%;border-collapse:collapse;border-radius:12px;border-spacing:0;box-shadow:0 0 13px 8px rgba(0,0,0,.1);margin-top:-18px;padding:0;text-align:left;vertical-align:top;width:100%"
                                    class="wrapper" align="center">
                                    <tr style="padding:0;text-align:left;vertical-align:top">
                                        <td class="wrapper-inner"
                                            style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;hyphens:auto;line-height:1.3;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                                                    ...
                                                                    <th
                                                                        ...
                                                                        <a style="Margin:0;color:#2199e8;font-family:Montserrat,sans-serif!important;font-weight:400;hyphens:none!important;line-height:1.3;margin:auto;padding:0;text-align:left;text-decoration:none"
                                                                            ...
                                                                            target="_blank"><img
                                                                                ...
                                                                                src="{{asset('/images/emails/whatsapp@2x.png')}}" alt></a>
                                                                    </th>
                                                                </tr>
                                                            </table>
                                                        </th>
                                                                ...
                                                                <tr
                                                                    ...
                                                                    <th
                                                                        ...
                                                                        <a style="Margin:0;color:#2199e8;font-family:Montserrat,sans-serif!important;font-weight:400;hyphens:none!important;line-height:1.3;margin:auto;padding:0;text-align:left;text-decoration:none"
                                                                            ...
                                                                            target="_blank"><img
                                                                                style="-ms-interpolation-mode:bicubic;border:none;clear:both;display:block;height:auto;margin:auto;max-width:20px;outline:0;text-decoration:none;width:auto"
                                                                                src="{{asset('/images/emails/facebook@2x.png')}}" alt></a>
                                                                    </th>
                                                                </tr>
                                                            </table>
                                                        </th>
                                                                ...
                                                                <tr
                                                                    ...
                                                                    <th
                                                                        ...
                                                                        <a style="Margin:0;color:#2199e8;font-family:Montserrat,sans-serif!important;font-weight:400;hyphens:none!important;line-height:1.3;margin:auto;padding:0;text-align:left;text-decoration:none"
                                                                            ...
                                                                            target="_blank"><img
                                                                                style="-ms-interpolation-mode:bicubic;border:none;clear:both;display:block;height:auto;margin:auto;max-width:20px;outline:0;text-decoration:none;width:auto"
                                                                                src="{{asset('/images/emails/instagram@2x.png')}}" alt></a>
                                                                    </th>
                                                                </tr>
                                                            </table>
                                                        </th>
                                                                ...
                                                                <tr
                                                                    ...
                                                                    <th
                                                                        ...
                                                                        <a style="Margin:0;color:#2199e8;font-family:Montserrat,sans-serif!important;font-weight:400;hyphens:none!important;line-height:1.3;margin:auto;padding:0;text-align:left;text-decoration:none"
                                                                            ...
                                                                            target="_blank"><img
                                                                                style="-ms-interpolation-mode:bicubic;border:none;clear:both;display:block;height:auto;margin:auto;max-width:20px;outline:0;text-decoration:none;width:auto"
                                                                                src="{{asset('/images/emails/pinterest@2x.png')}}" alt></a>
                                                                    </th>
                                                                </tr>
                                                            </table>
                                                        </th>
                                                                ...
                                                                <tr
                                                                    ...
                                                                    <th
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            Este mensaje fue enviado por Armario Móvil
                                                                            S.A.<br>Quito - Ecuador © 2019 Derechos
                                                                            Reservados</p><a target="_blank"
                                                                    ...
                                                                    <tr
                                                                        ...
                                                                        <th
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                {{ $user->email }}<br><br><strong>AVISO:</strong>
                                                                                Este e-mail así como cualquier
                                                                                información, archivo o documento adjunto
                                                                                son para el uso exclusivo y confidencial
                                                                                del destinatario(s) a quien(es) iban
                                                                                dirigidos. Este mensaje contiene
                                                                                información confidencial y de propiedad
                                                                                exclusiva de Armario Móvil que no puede
                                                                                ser leída, buscadas, distribuidas, ni
                                                                                utilizada por nadie más que el
                                                                                destinatario a quien iba dirigida. Si
                                                                                usted no es la persona a quien debía ir
                                                                                dirigido este e-mail, por favor no lea,
                                                                                no distribuya ni emprenda ninguna acción
                                                                                en relación con este mensaje. Si cree
                                                                                haber recibido este e-mail por error,
                                                                                avísele a quien se lo envió y elimine
                                                                                inmediatamente de su computadora este
                                                                                mensaje y sus documentos adjuntos.</p>
                                                                        </th>
                                                                        <th class="expander"
                                                                            style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0!important;text-align:left;visibility:hidden;width:0">
                                                                        </th>
