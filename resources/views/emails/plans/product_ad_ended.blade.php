...
<head>
    ...
    <title>Anuncio finalizado</title>
    <style>
        @media only screen {
            html {
                min-height: 100%;
                                                                    ...
                                                                    <tr
                                                                        ...
                                                                        <th
                                                                            ...
                                                                            <table class="spacer"
                                                                                ...
                                                                                src="{{asset('/images/emails/icon-mkt.png')}}" alt>
                                                                            <h1 class="text-center"
                                                                                ...
                                                                                Tu anuncio ha <br>finalizado</h1>
                                                                        </th>
                                                                        <th class="expander"
                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <th
                                                                style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
                                                                <p
                                                                    style="Margin:0;Margin-bottom:10px;color:#181b48;font-family:Montserrat,sans-serif!important;font-size:14px;font-weight:400;hyphens:none!important;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:left">
                                                                    {{ $product->store->name }}, tu producto <strong>{{ $product->name }}</strong> ha sido finalizado, por favor
                                                                    debes confirmarnos si tienes el producto disponible
                                                                    contigo.<br><br>Para activar nuevamente tu
                                                                    publicación solo debes dar clic en el botón de
                                                                    <strong>reactivar anuncio</strong>, si no tienes
                                                                    este producto disponible, ignora este mensaje.</p>
                                                            </th>
                                                            <th class="expander"
                                                                style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0!important;text-align:left;visibility:hidden;width:0">
                                                            </th>
                                                ...
                                                <th class="small-12 large-4 columns first"
                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <th
                                                                style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
                                                                <div style="-ms-interpolation-mode:bicubic;border-radius:50%;clear:both;display:block;margin:auto;outline:0;text-decoration:none;width:150px;height:150px;background-size:cover;background-position:center;background-image:url('{{ $product->main_image_thumbnail }}')">
                                                                                    ...
                                                                                    <tr
                                                                                        ...
                                                                                        <th
                                                                                            ...
                                                                                            <p class="small-text-center"
                                                                                                ...
                                                                                                <span
                                                                                                    style="color:#ed1c24;font-family:Montserrat,sans-serif!important;hyphens:none!important">Finalizado</span>
                                                                                            </p>
                                                                                        </th>
                                                                                    </tr>
                                                                                </table>
                                                        ...
                                                        <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <th
                                                                ...
                                                                <p
                                                                    ...
                                                                    {{ $product->store->user->email }}<br><br><strong>AVISO:</strong>
