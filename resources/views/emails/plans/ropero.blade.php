        ...
        <tr style="padding:0;text-align:left;vertical-align:top">
            <td class="center" align="center" valign="top"
                ...
                <center data-parsed style="min-width:580px;width:100%">
                    ...
                    <!-- Content Header -->
                    <table
                        style="Margin:0 auto;background:#fefefe;border-collapse:collapse;border-radius:18px;border-spacing:0;box-shadow:0 0 13px 8px rgba(250,102,153,.3);float:none;margin:0 auto;padding:0;text-align:center;vertical-align:top;width:580px"
                                                                ...
                                                                <table
                                                                    ...
                                                                    <tr
                                                                        ...
                                                                        <th
                                                                            ...
                                                                            src="{{asset('/images/emails/plan-ropero.png')}}" alt>
                                                                            <p class="text-center"
                                                        ...
                                                        <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <th
                                                                ...
                                                                <p class="text-center"
                                                                    ...
                                                                    Comercial<br>Publicación de 5 productos<br>15 días
                                                                    de anuncio activos<br>Botón de Pago<br>Servicio
                                                                    logístico<br>Calculadora de precios, impuestos y
                                                                    comisiones<br>Tarifa de
                                                                    comisión sobre la venta de un 22%<br>Certificado SSL
                                                                    ...
                                                                    historia por marca por día)<br><br><strong
                                                                      
                                                                        style="font-size:16px">Precio</strong><br>Totalmente gratis</p>
                                                            </th>
                                                            <th class="expander"
                                                                style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0!important;text-align:left;visibility:hidden;width:0">
                                                            </th>
