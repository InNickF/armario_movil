...
@section('breadcrumbs')
<div class="col-12 breadcrumb-container breadcrum mb-4 mb-md-3 text-sm">
  <small>
...
@include('partials.stores.store-header', ['store' => $product->store])
...
<div class="content-i">
  <div class="content-box">
    <div class="element-wrapper">
      ...
      <single-product product-id="{{$product->id}}" user-id="{{auth()->check() ? auth()->user()->id : null}}" @on-add-to-cart="addProductToCart"></single-product>
...
<div class="my-4 pb-4">
    ...
    @include('partials.products.product-carousel', ['products' => $product->store->products()->where('is_active', true)->hasStock()->latest()->get()])

    <div class="text-center my-4">
    <a href="{{$product->store->url}}" class="btn btn-outline-primary btn-sm font-weight-bold">Ver tienda del vendedor</a>
    </div>
</div>
