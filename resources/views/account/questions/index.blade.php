    ...
    <div class="card-body d-flex flex-wrap">
        ...
        <div class="row">
          ...
          <div class="col-12 col-lg-2 order-lg-3 order-1 my-2">
            <div class="d-flex flex-wrap align-items-center">
              ...
              @else
              <div class="btn mx-auto btn-yellow btn-sm">Pendiente</div>
              @endif
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-12 col-md-12">
                <div class="d-flex align-items-center">
                  ...
                  @if ($answer->user_id && ($answer->user_id == $question->product->store->user->id))
     ...
     <div class="col-10 px-0">
           <div class="d-flex justify-content-between align-items-start">
              ...
              <a href="{{ route('account.questions.edit', $question->id)}}"
