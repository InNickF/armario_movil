<template>
  <div>
    <div class="row">
      <div class="col-sm-12 col-lg-8" v-if="filter == 'is_paying'">
        <div class="d-flex align-items-center mb-2">
          <img :src="baseUrl + '/images/icons/house-icon.svg'" class="icon-sm mr-2" alt />
          <div class="h4 text-primary mb-0 mt-1">Dirección de entrega de productos</div>
        </div>
        <p
          class="text-sm text-primary mb-4"
        >Aquí podrás agregar la dirección donde deseas que tus productos sean enviados.</p>
        <shipping-addresses
